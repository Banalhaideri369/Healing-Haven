    ...
    >
      ...
      <div className="container mx-auto px-6 max-w-4xl relative z-10">
        ...
        >
          ...
          <div className="px-8 md:px-14 pt-10 pb-2 text-center border-b border-primary/10">
            <h3 className="font-serif text-3xl md:text-4xl lg:text-[2.8rem] text-foreground leading-snug mb-4">
            ...
            <p className="text-primary/80 text-sm md:text-base font-light italic leading-relaxed max-w-xl mx-auto mb-8">
          ...
          <div className="px-8 md:px-14 py-10">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-6 border-t border-primary/20">
              ...
              <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                {checkoutError && (
                  <p className="text-red-400 text-xs text-center w-full">{checkoutError}</p>
                )}
                <button
